...
Le nombre de contraintes de ce type est égal aux nombres de modalités croitsés.
...
## Estimation des probabiltés par maximisation de l'entropie
...
**Les grandes variations des moyennes de revenu sont prédites, les petites variations sont mal prédites : la précision est probablement suffisante pour notre usage**
